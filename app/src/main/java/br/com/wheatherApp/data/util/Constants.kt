...
object Constants {
    ...
    const val API_HOURLY_FORECAST_URL = "${BuildConfig.WEATHER_API_URL}/forecast/hourly?"
    const val API_DAILY_FORECAST_URL = "${BuildConfig.WEATHER_API_URL}/forecast/daily?"
